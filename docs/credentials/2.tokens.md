...
### Option 1: Git Credential Manager (Best)

**Git Credential Manager** (GCM) is the modern, secure way to store credentials.
...
=== "Windows"
    ...
    **Included with Git for Windows!**
    ...
    If installed, it automatically works:
    ```bash
    $ git clone https://github.com/username/repo.git
    # A window will pop up asking for credentials
    # Enter username and token
    # GCM stores them securely in Windows Credential Manager
    ```
    
    **Next time:** No prompt - uses stored credentials automatically!
...
=== "macOS"
    ...
    **Install via Homebrew:**
    ...
    Or download from: [github.com/git-ecosystem/git-credential-manager](https://github.com/git-ecosystem/git-credential-manager/releases)
...
=== "Linux"
    ...
    **Install:**
    ...
    Download from [GitHub Releases](https://github.com/git-ecosystem/git-credential-manager/releases)
    
    ```bash
    # Example for Debian/Ubuntu
    wget https://github.com/git-ecosystem/git-credential-manager/releases/download/v2.x.x/gcm-linux_amd64.2.x.x.deb
    sudo dpkg -i gcm-linux_amd64.2.x.x.deb
...
- ✅ Automatic token refresh (for some setups)

### Option 2: Git Credential Store (Permanent)
