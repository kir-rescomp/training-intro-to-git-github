...
2. Click <kbd><img src="../images/github-pull-request-icon.svg" alt="PR"> **Pull requests**</kbd> → <kbd style="background-color: green; color: white;">New pull request</kbd>
...
- Once satisfied, clicks <kbd style="background-color:green;  color:white;">Merge pull request</kbd>
