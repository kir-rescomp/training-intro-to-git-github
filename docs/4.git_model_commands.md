...
If both Dr.X and Dr.Y changed the same part of **data_preprocessing.py**, Git will raise a merge conflict —
just like two people editing the same figure in a shared paper draft.

They’ll resolve it manually, test again, and commit the final merged version.
